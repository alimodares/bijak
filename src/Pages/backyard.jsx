...
const Registration = () => {
  ...
  useEffect(() => {
    console.log("goods_details:", goods_details);
}, [goods_details]);
  ...
  return (
    <div className=" inset-0 flex flex-col justify-between items-center p-6">
      ...
      <div className="absolute bottom-6 left-0 right-0 flex flex-col items-center">
        {clickedInput ? (
          <button onClick={() =>(fetchPricing , setIsOpen(true))} className="py-2 px-32 text-xl bg-[#D40700] border-2 text-white rounded-full hover:border-2 hover:border-[#D40700] hover:bg-white hover:text-[#D40700] transition-colors duration-300">
            محاسبه قیمت
          </button>
        ) : (
